        ...
        <div className="lg:col-span-2">
          ...
          <aside className="mb-8 rounded-2xl bg-red-50 px-5 py-5 sm:px-7 sm:py-6 flex items-center gap-5 sm:gap-6" aria-label="Mensagem de acolhimento">
            ...
            <div>
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-brand-900 mb-1">Você não está sozinha.</h3>
              <p className="text-gray-700 leading-relaxed">
                Buscar ajuda é um direito. Procure um canal oficial ou um serviço da rede de atendimento quando se sentir segura para fazê-lo.
              </p>
            </div>
          </aside>

          <h3 className="text-xl font-bold text-brand-900 mb-6 flex items-center gap-2">
            <span className="w-8 h-8 bg-brand-900 text-white rounded-full flex items-center justify-center text-sm" aria-hidden="true">1</span>
            Passo a Passo da Denúncia
          </h3>

          <div className="space-y-8 relative pl-8 border-l-2 border-gray-200 ml-4">
            <div className="relative">
              <div className="absolute -left-[41px] top-0 w-6 h-6 bg-action rounded-full border-4 border-white shadow-sm" aria-hidden="true" />
            ...
            <div className="relative">
              <div className="absolute -left-[41px] top-0 w-6 h-6 bg-brand-400 rounded-full border-4 border-white shadow-sm" aria-hidden="true" />
          ...
          <h3 className="text-xl font-bold text-brand-900 mt-12 mb-6 flex items-center gap-2">
            <span className="w-8 h-8 bg-brand-900 text-white rounded-full flex items-center justify-center text-sm" aria-hidden="true">2</span>
        ...
        <div className="space-y-6">
          <div className="bg-brand-50 rounded-xl p-6 border border-brand-100">
            <h4 className="font-bold text-brand-900 mb-4 flex items-center gap-2">
              <PhoneCall size={20} aria-hidden="true" /> Telefones Úteis
            </h4>
            <ul className="space-y-4">
              ...
              <li className="flex justify-between items-center border-b border-brand-200 pb-2 gap-4">
                <span className="text-gray-700">Central de Atendimento à Mulher</span>
            ...
            <a
              ...
              className="mt-5 inline-flex items-center gap-1 text-sm font-semibold text-action hover:underline focus:outline-none focus:ring-2 focus:ring-action focus:ring-offset-2 rounded"
            >
              Consultar informações oficiais <ExternalLink size={14} aria-hidden="true" />
            </a>
          </div>

          <Link to="/map" className="block rounded-xl focus:outline-none focus:ring-2 focus:ring-action focus:ring-offset-2">
            <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm hover:shadow-md transition-all group">
              ...
              <span className="text-sm font-semibold text-brand-900 group-hover:text-action flex items-center gap-1">
                Acessar Mapa <ChevronRight size={16} aria-hidden="true" />
              </span>
            </div>
          </Link>
        </div>
