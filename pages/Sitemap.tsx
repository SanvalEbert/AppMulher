      ...
      <div className="space-y-12">
        ...
        <div className="bg-gray-50 p-8 rounded-xl border border-gray-200 overflow-x-auto">
          <h3 className="font-bold text-brand-900 mb-8 flex items-center gap-2">
            <Layout size={20} aria-hidden="true" /> Arquitetura da Informação
          </h3>

          <div className="flex flex-col items-center min-w-[980px]">
            <Node label="Página Inicial" />
            <div className="h-8 w-px bg-gray-300"></div>
            <div className="h-px w-[90%] bg-gray-300"></div>
            <div className="flex justify-between w-[90%] pt-4 gap-4">
